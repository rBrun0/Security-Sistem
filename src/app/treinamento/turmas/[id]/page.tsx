    ...
    <div className="space-y-6">
      ...
      <Dialog open={isAddParticipante} onOpenChange={setIsAddParticipante}>
        <DialogContent className="max-w-lg">
          ...
          <Tabs defaultValue="colaborador" className="mt-4">
            ...
            <TabsContent value="colaborador">
              <form onSubmit={handleAddParticipante} className="space-y-4 mt-4">
                    ...
                    <SelectContent>
                      {colaboradores
                        ...
                        .map((colaborador) => (
                          ...
                          >
                            {colaborador.name} - {colaborador.cpf}
                          </SelectItem>
                        ))}
                    </SelectContent>
                  </Select>
                ...
                {participanteForm.name && (
                  <div className="p-4 bg-slate-50 rounded-lg text-sm space-y-1">
                    ...
                    <p>
                      <strong>CPF:</strong> {participanteForm.cpf || "-"}
                    </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditForm((old) => ({ ...old, workload: e.target.value }))
                  }
                />
              </div>
              <div>
