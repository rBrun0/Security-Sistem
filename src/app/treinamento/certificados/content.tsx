...
function CertificadosContent() {
  ...
  const getSignatureUrl = (item?: unknown) => {
    if (!item || typeof item !== "object") return "";

    const data = item as Record<string, unknown>;
    const signature =
      data.signatureUrl || data.signature_url || data.assinatura_url;
        ...
        <div className="print-area">
          {viewMode === "certificado" && participante ? (
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <div className="p-8 min-h-150 border-8 border-double border-purple-200 m-4 relative">
                ...
                <div className="text-center space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-8 mt-12 pt-8">
                    ...
                    <div className="text-center">
                      <div className="border-t-2 border-slate-400 pt-2 mt-12">
                        {getSignatureUrl(instrutor) ? (
                          <img
                            src={getSignatureUrl(instrutor)}
                            alt="Assinatura"
                            className="h-12 mx-auto mb-2"
                          />
                        ) : (
              ...
              <div className="p-8 min-h-150 border-8 border-double border-purple-200 m-4 mt-8 page-break-before">
                ...
                <div className="grid grid-cols-2 gap-8 mt-8">
                  ...
                  <div>
                    ...
                    {getSignatureUrl(responsavel) && (
                      <img
                        src={getSignatureUrl(responsavel)}
                        alt="Assinatura"
                        className="h-12 mt-4"
                      />
                    )}
